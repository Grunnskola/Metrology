...
namespace Metrics
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string iHelp;
            FileInfo myFile = new FileInfo("testing.txt");
            FileStream myStream = myFile.Open(FileMode.Open, FileAccess.ReadWrite);
            StreamReader file = new StreamReader(myStream);
            iHelp = file.ReadToEnd();

            Chepina metricsChepina = new Chepina();
        
            textBox2.AppendText(Convert.ToString(metricsChepina.GetCountInputVariables(iHelp)));
            textBox3.AppendText(Convert.ToString(metricsChepina.GetCountModificatedVariables(iHelp)));
            textBox4.AppendText(Convert.ToString(metricsChepina.GetCountControlVariables(iHelp)));
            textBox5.AppendText(Convert.ToString(metricsChepina.GetCountUnusedVariables(iHelp)));
            textBox1.AppendText(Convert.ToString(metricsChepina.ExecuteChepin(iHelp)));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            dataGridView.Columns.Add("c1", "Analyze");
